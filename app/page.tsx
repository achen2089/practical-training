...
export default function Home() {
  return (
    <div >
      ...
      <h1 className="item-center mt-10 scroll-m-20 border-b pb-2 pt-8 text-3xl font-semibold tracking-tight transition-colors first:mt-0">AI for Personalized Training</h1>
